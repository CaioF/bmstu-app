      ...
      <div className="container-contact100">
        <div className="wrap-contact100">
          <form name ="myForm" className="contact100-form">
            ...
            <div className="wrap-input100">
              <span className="label-input100">Должность и кафедра Вашего руководителя</span>
              <input className="input100" type="text" name="faculty_p" value={this.state.faculty} onChange={(event)=>this.handleInputChange(event)} placeholder="Агент СМЕРШа" />
            </div>
