...
export default class Form extends Component {
  ...
  handleClick(event) {
    ...
    {
      fetch('http://localhost:8008/api/pdf', { //IPv4
      ...
      .then(function (response) {
        if (response.status === 200) {
          window.setTimeout(window.location='http://localhost:8008/api/pdf', 60); //IPv4
        } else {
        ...
        <div className="wrap-contact100">
          <form name ="myForm" className="contact100-form">
            ...
            <div className="wrap-input100">
              <span className="label-input100">Название курсовой работы</span>
